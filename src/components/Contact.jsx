...
export default function Contact() {
  ...
  return (
    <section id="contact" ref={sectionRef} className="py-28 px-6 max-w-5xl mx-auto">
      ...
      <div ref={contentRef} className="space-y-8">
        ...
        <a
          ...
          className="inline-block text-2xl md:text-3xl font-medium text-white hover:text-surface-300 transition-colors"
        >
          {profile.email}
        </a>
        <a
          ...
          className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-white text-surface-950 font-medium text-sm hover:bg-surface-200 transition-colors"
        >
